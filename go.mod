module github.com/sam1el/snyk-api
...
require (
	github.com/go-viper/mapstructure/v2 v2.4.0 // indirect; indirect - security fix
	golang.org/x/crypto v0.45.0 // indirect; indirect - security fix
)
